...
def train(args):
    ...
    # args.modelf_map = args.modelf_map if "modelf_map" in args else None
    # args.modelf_mae = args.modelf_mae if "modelf_mae" in args else None
    # if args.modelf_map:
    #     state_dict_model = torch.load(args.modelf_map)
    ...
    #     print('ys1')
    # if args.modelf_mae:
    #     state_dict_model = torch.load(args.modelf_mae)
    #     new_state_dict = OrderedDict()
    #     for k, v in state_dict_model.items():
    ...
    for epoch in range(args.nepochs):
        for batchi, (imgs, trans, rots, intrins, post_trans, post_rots, lidar_data, lidar_mask, car_trans, 
            ...
            (semantic, embedding, direction),a,b,c,d = model(imgs.cuda(), trans.cuda(), rots.cuda(), intrins.cuda(),
...
if __name__ == '__main__':
    ...
    parser.add_argument("--logdir", type=str, default='./output/hd60*30-C/120')
    # nuScenes config
    ...
    parser.add_argument("--model", type=str, default='PMapNet_sdmap_C')
    ...
    parser.add_argument("--steplr", type=int, default=3)
    
    parser.add_argument("--weight_decay", type=float, default=1e-7)

    # finetune config
    parser.add_argument('--finetune', action='store_true')
    # parser.add_argument('--modelf_mae', type=str, default="/app/ckpth/model19.pt")
    # parser.add_argument('--modelf_map', type=str, default='/app/P-MapNet/new_60/P-MapNet-60m/output/60*30-new-base/model29.pt')
    # # data config
